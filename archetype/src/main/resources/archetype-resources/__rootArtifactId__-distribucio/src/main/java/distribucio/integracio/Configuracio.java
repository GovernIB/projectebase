...
public class Configuracio {
    ...
    @Inject
    @ConfigProperty(name = "${package}.distribucio.int.distribucio.endpoint")
    private String endpoint;

    @Inject
    @ConfigProperty(name = "${package}.distribucio.int.distribucio.usuari")
    private String usuari;

    @Inject
    @ConfigProperty(name = "${package}.distribucio.int.distribucio.secret")
