...
import ${package}.distribucio.repository.CannotLockException;
...
public class ProcessarAnotacioServiceBean implements ProcessarAnotacioService {
    ...
    @Inject
    @ConfigProperty(name = "${package}.distribucio.organs")
    private List<String> organs;

    @Inject
    @ConfigProperty(name = "${package}.distribucio.serieDocumental")
    private String serieDocumental;

    @Inject
    @ConfigProperty(name = "${package}.distribucio.prefixExpedient")
