...
public class WsInInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        LOG.info("WsInInterceptor::handleMessage() => ${prefixuppercase}_USER " + context.isUserInRole(Constants.${prefixuppercase}_USER));
        LOG.info("WsInInterceptor::handleMessage() => ${prefixuppercase}_ADMIN " + context.isUserInRole(Constants.${prefixuppercase}_ADMIN));
    }
