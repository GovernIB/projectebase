...
@WebFault(name = "WsI18NError", targetNamespace = "http://impl.v1.ws.${rootArtifactId}.caib.es/")
public class WsI18NException extends Exception {
    ...
    public WsI18NException(String message, ${package}.ws.api.v1.WsI18NError wsI18NError) {
        super(message);
        this.wsI18NError = wsI18NError;
    }

    public WsI18NException(String message, ${package}.ws.api.v1.WsI18NError wsI18NError, Throwable cause) {
        super(message, cause);
        this.wsI18NError = wsI18NError;
    }

    public ${package}.ws.api.v1.WsI18NError getFaultInfo() {
