...
import ${package}.persistence.model.BaseEntity;
 ...
 * el mètode {@link ${symbol_pound}getPath(Enum)} per mapejar noms d'atributs a expressions "path" que els mètodes d'aquesta
...
public abstract class AbstractCriteriaHelper<E extends BaseEntity, A extends Enum<A> & Atribut> {
     ...
     * cas fa un equals.
     * Obtendrà l'expressió "path" amb la que comprar amb el mètode {@link ${symbol_pound}getPath(Enum)}. Les subclasses poden
     ...
     * Per obtenir l'expressió "path" amb la que construir els Order empra el mètode {@link ${symbol_pound}getPath(Enum)}.
