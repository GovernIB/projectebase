...
public class UnitatOrganicaServiceTest {
    ...
    private static final String BASE_URL = "http://localhost:8080/${parentArtifactId}/api/services";

    // Nom d'usuari i password a emprar per les peticions que necesisten autenticació. Cal posar un
    // usuari/password que tengui rol ${prefixuppercase}_ADMIN a per el mòdul web de l'api REST.
