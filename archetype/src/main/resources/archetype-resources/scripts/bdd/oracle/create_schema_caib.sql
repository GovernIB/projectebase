...
create index ${prefixuppercase}_UNITAT_CODIDIR3_UK_I on ${prefixuppercase}_UNITATORGANICA (CODIDIR3);
 ...
 -- INICI GRANTS
    grant select on ${prefixuppercase}_PROCEDIMENT_SEQ start with 1 increment by  1 to www_${rootArtifactId};
    grant select on ${prefixuppercase}_UNITATORGANICA_SEQ start with 1 increment by  1 to www_${rootArtifactId};
    grant select,insert,delete,update on ${prefixuppercase}_PROCEDIMENT to www_${rootArtifactId};
    grant select,insert,delete,update on ${prefixuppercase}_UNITATORGANICA to www_${rootArtifactId};
 -- FINAL GRANTS
