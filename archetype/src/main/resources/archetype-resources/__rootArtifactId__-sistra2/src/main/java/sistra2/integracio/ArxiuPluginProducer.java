...
public class ArxiuPluginProducer {
    ...
    @Inject
    @ConfigProperty(name = "${package}.sistra2.int.arxiu.endpoint")
    private String endpoint;

    @Inject
    @ConfigProperty(name = "${package}.sistra2.int.arxiu.aplicacioCodi")
    private String aplicacioCodi;

    @Inject
    @ConfigProperty(name = "${package}.sistra2.int.arxiu.usuari")
    private String usuari;

    @Inject
    @ConfigProperty(name = "${package}.sistra2.int.arxiu.secret")
