...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.commons.rest.filters;
...
import static ${package}.commons.rest.RestConstants.REQUEST_LOCALE;
import static ${package}.commons.rest.RestConstants.SUPPORTED_LOCALES;
