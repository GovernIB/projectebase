...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.apifirmasimple.example.web.form;
...
import ${package}.apifirmasimple.example.web.utils.ValidMultipartFile;
...
public class FirmaForm {
    ...
    // @NotBlank(message="${symbol_pound}{T(com.my.package.MyUtil).getMessage()}")
