 ...
 *         &lt;element name="args" type="{http://impl.v1.ws.archetype.projectebase.fundaciobit.org/}wsI18NArgument" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "wsI18NTranslation", propOrder = {
    "code",
    "args"
})
public class WsI18NTranslation {
    ...
    public List<WsI18NArgument> getArgs() {
        if (args == null) {
            args = new ArrayList<WsI18NArgument>();
        }
        return this.args;
    }
