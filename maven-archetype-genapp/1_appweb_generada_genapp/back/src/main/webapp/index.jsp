  ...
  if (existsSecureContextStatic == null) {
    try {  
      ...
      if (propData == null) {
        ...
        String value = properties.getProperty("projectebasearchetype.clientcert");
...
if (existsSecureContext) {
  ...
  final boolean thisContextIsClientCert = "/projectebasearchetypes".equals(context);
  
  if (thisContextIsClientCert && "http".equals(scheme)) {
    // Hem de passar a projectebasearchetype
    context = "/projectebasearchetype";
  } else {
    // Hem de passar a projectebasearchetypes
    if (!thisContextIsClientCert && "https".equals(scheme)) {
      context ="/projectebasearchetypes";
    }
  }
