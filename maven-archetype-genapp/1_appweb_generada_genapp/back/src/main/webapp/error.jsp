<%@page import="org.fundaciobit.projectebase.archetype.back.security.LoginException"
...
try {
    ...
    if (log.isDebugEnabled()) {
          log.debug(" =================  ENTRA ERROR.JSP (" + idError 
    ...
    if (e == null){
        ...
        if (pageContext.getErrorData() != null) {
           System.err.println("[[" + idError + "]] Requested resource: "
