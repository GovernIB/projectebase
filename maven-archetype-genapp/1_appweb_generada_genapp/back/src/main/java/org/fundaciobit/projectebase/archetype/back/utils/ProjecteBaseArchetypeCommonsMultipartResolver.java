 ...
 */
@Component
public class ProjecteBaseArchetypeCommonsMultipartResolver extends
    org.springframework.web.multipart.commons.CommonsMultipartResolver {

  protected final Logger log = Logger.getLogger(getClass());

  public ProjecteBaseArchetypeCommonsMultipartResolver() {
    super();
  }
  ...
  public MultipartHttpServletRequest resolveMultipart(HttpServletRequest request)
	...
	*/
    ...
    try {
      ...
      throw new ProjecteBaseArchetypeMaxUploadSizeExceededException(musee.getCause(),
