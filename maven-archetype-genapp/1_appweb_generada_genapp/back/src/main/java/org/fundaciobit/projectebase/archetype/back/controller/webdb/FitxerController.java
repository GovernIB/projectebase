...
import org.fundaciobit.projectebase.archetype.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends org.fundaciobit.projectebase.archetype.back.controller.ProjecteBaseArchetypeBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = org.fundaciobit.projectebase.archetype.ejb.FitxerLocal.JNDI_NAME)
