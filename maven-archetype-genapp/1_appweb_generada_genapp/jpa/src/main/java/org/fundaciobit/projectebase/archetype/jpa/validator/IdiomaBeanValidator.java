...
public class IdiomaBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.projectebase.archetype.model.dao.IIdiomaManager __idiomaManager;


  public final IdiomaValidator<IdiomaJPA> _validator;


  public IdiomaBeanValidator(org.fundaciobit.projectebase.archetype.model.dao.IIdiomaManager __idiomaManager) { 
  ...
  public IdiomaBeanValidator(IdiomaValidator<IdiomaJPA> _validator,
     org.fundaciobit.projectebase.archetype.model.dao.IIdiomaManager __idiomaManager) {
    this.__idiomaManager = __idiomaManager;
