...
@Entity
@Table(name = "${prefix}_traduccio" )
@SequenceGenerator(name="${projectnameuppercase}_SEQ", sequenceName="${prefix}_${parentArtifactId}_seq", allocationSize=1)
...
private static final long serialVersionUID = -326205279L;
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="${projectnameuppercase}_SEQ")
	@Index(name="${prefix}_traduccio_pk_i")
  ...
  @CollectionOfElements(fetch= FetchType.EAGER,targetElement = ${package}.jpa.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="${prefix}_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")})
  @org.hibernate.annotations.MapKey(columns={@Column(name="idiomaid")})
  @ForeignKey(name="${prefix}_traducmap_traduccio_fk") 
  private Map<String, ${package}.jpa.TraduccioMapJPA> traduccions =  new HashMap<String, ${package}.jpa.TraduccioMapJPA>();

  public Map<String, ${package}.jpa.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, ${package}.jpa.TraduccioMapJPA> _traduccions_) {
  ...
  public ${package}.jpa.TraduccioMapJPA getTraduccio(String idioma) {
    return (${package}.jpa.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, ${package}.jpa.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
