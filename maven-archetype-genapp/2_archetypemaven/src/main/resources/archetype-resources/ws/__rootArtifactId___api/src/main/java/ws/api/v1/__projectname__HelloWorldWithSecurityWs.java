...
@WebService(targetNamespace = "http://impl.v1.ws.${packageinverse}/", name = "${projectname}HelloWorldWithSecurityWs")
@SOAPBinding(style = SOAPBinding.Style.RPC)
public interface ${projectname}HelloWorldWithSecurityWs {

    @WebResult(name = "return", targetNamespace = "http://impl.v1.ws.${packageinverse}/", partName = "return")
    @WebMethod
