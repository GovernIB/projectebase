...
<title>Benvingut a ${projectname}</title>
...
<script type="text/javascript">
    ...
    function openModal(url,accio) {
         ...
         ${symbol_dollar}('${symbol_pound}myModal').modal(accio);
    }
    ...
    ${symbol_dollar}('body')
         .append(
                 ...
                 + (formName? ('submitTo(${symbol_escape}'' + formName + '${symbol_escape}',') : 'goTo(') 
                 + '${symbol_escape}''+url+'${symbol_escape}')">'+traduccions.type['boto.continuar']+'</button>'
                 + '</div></div>');
    }
