...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form pull-right">
    ...
    <input type="button" class="btn" onclick="goTo('<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{__theForm.fitxer.fitxerID}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
    <c:if test="${symbol_dollar}{!__theForm.nou && __theForm.deleteButtonVisible}">
    <button type="button" class="btn btn-danger" onclick="openModal('<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{__theForm.fitxer.fitxerID}/delete"/>','show');"><fmt:message key="genapp.delete"/></button>
    </c:if>
    ...
    <c:set var="pk" value="${symbol_dollar}{__theForm.fitxer.fitxerID}"/>
