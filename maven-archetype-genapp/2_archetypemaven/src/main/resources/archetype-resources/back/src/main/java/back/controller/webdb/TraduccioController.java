...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.back.controller.webdb;
...
import ${package}.back.form.webdb.*;
import ${package}.back.form.webdb.TraduccioForm;

import ${package}.back.validator.webdb.TraduccioWebValidator;
...
public class TraduccioController
    extends ${package}.back.controller.${projectname}BaseController<Traduccio, java.lang.Long> implements TraduccioFields {

  @EJB(mappedName = ${package}.ejb.TraduccioLocal.JNDI_NAME)
