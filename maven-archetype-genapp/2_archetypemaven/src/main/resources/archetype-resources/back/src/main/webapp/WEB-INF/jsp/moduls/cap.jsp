  ...
  <div class="pull-right main-menu">
    <ul class="user-nav pull-right dropdown">
      ...
      <li>
        ...
        <li><a class="" href="${symbol_pound}"><i> Current Item </i> </a></li>
      ...
      <li>
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
          <li><a tabindex="-1" href="${symbol_pound}">Configuració</a></li>
...
%>
    ...
    <c:forEach  var="idioma"  items="${symbol_dollar}{idiomes}" varStatus="status">
       <a href="<c:url value="${symbol_dollar}{urlActual}"><c:param name="lang" value="${symbol_dollar}{idioma}"/></c:url>">
