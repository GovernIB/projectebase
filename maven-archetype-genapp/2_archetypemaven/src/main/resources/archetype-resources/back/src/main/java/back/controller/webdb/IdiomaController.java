...
import ${package}.back.validator.webdb.IdiomaWebValidator;
...
public class IdiomaController
    extends ${package}.back.controller.${projectname}BaseController<Idioma, java.lang.String> implements IdiomaFields {

  @EJB(mappedName = ${package}.ejb.IdiomaLocal.JNDI_NAME)
