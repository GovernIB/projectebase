...
import ${package}.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends ${package}.back.controller.${projectname}BaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = ${package}.ejb.FitxerLocal.JNDI_NAME)
