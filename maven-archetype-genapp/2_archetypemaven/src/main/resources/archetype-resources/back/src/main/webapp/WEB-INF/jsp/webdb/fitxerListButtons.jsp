...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <td>
          <c:set var="pk" value="${symbol_dollar}{fitxer.fitxerID}"/>
          <c:choose>
           <c:when test="${symbol_dollar}{__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn " href="<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{fitxer.fitxerID}/edit"/>" onclick="" title="<fmt:message key="genapp.edit"/>">
               <i class="icon-pencil"></i>
            </a>
            </c:if>
            <c:if test="${symbol_dollar}{__theFilterForm.deleteButtonVisible}">
            <a class="btn btn-danger" href="${symbol_pound}myModal" onclick="openModal('<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{fitxer.fitxerID}/delete"/>','show');" title="<fmt:message key="genapp.delete"/>">
      ...
      <ul class="dropdown-menu pull-right" style="min-width:35px;padding:5px 5px 0px 5px;margin:0px;font-size: 12px" >
            <c:if test="${symbol_dollar}{__theFilterForm.editButtonVisible}">
            <li>
            <a class="btn  btn-small a_item" style="margin-bottom:5px;" href="<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{fitxer.fitxerID}/edit"/>" onclick="">
            <i class="icon-pencil"></i>
            ...
            <c:if test="${symbol_dollar}{__theFilterForm.deleteButtonVisible}">
            <li>
            <a class="btn btn-danger btn-small a_item" style="margin-bottom:5px;color: white;" href="${symbol_pound}myModal" onclick="openModal('<c:url value="${symbol_dollar}{contexte}/${symbol_dollar}{fitxer.fitxerID}/delete"/>','show');">
            <i class="icon-trash icon-white"></i>
