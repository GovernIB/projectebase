...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <c:if test="${symbol_dollar}{fn:length(groupby_items) > 0}">
    ...
    <c:if test="${symbol_dollar}{__theFilterForm.deleteSelectedButtonVisible && __theFilterForm.visibleMultipleSelection && not empty idiomaItems}">
      <a class="btn btn-danger btn-small pull-right" style="color: white;" href="${symbol_pound}myModal"
        onclick="openModalSubmit('<c:url value="${symbol_dollar}{contexte}/deleteSelected"/>','show', 'idioma');"
