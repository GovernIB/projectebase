 ...
 * 
 */
public class ${projectname}MaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof ${projectname}MaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof ${projectname}MaxUploadSizeExceededException) {
          msgCode = ((${projectname}MaxUploadSizeExceededException) musee).getMsgCode();
        } else {
