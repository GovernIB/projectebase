 ...
 * </p>
 */
public class I18NTranslator2 implements Serializable {
     ...
     */
    private static final ConcurrentMap<List<String>, I18NTranslator2> INSTANCES = new ConcurrentHashMap<>();
     ...
     */
    private I18NTranslator2(List<String> bundleNamesList) {
     ...
     */
    public static I18NTranslator2 from(String... bundleNames) {
        ...
        return INSTANCES.computeIfAbsent(Arrays.asList(bundleNames), I18NTranslator2::new);
    }
