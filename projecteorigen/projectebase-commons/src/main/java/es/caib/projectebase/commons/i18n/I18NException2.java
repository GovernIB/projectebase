 ...
 * Emprarà una instància de {@link I18NTranslator2} per traduir els missatges.
 * Les subclasses han d'implementar el mètode {@link #getTranslator()} per indicar
 * la instància a emprar per traduir els missatges.
 */
public abstract class I18NException2 extends Exception {
     ...
     */
    public I18NException2(String message) {
        super(message);
    }
     ...
     */
    public I18NException2(String message, Object... parameters) {
        super(message);
     ...
     * @param message etiqueta del missatge a traduir.
     */
    public I18NException2(Throwable cause, String message) {
        super(message, cause);
    }
     ...
     * @param parameters paràmetres del missatge.
     */
    public I18NException2(Throwable cause, String message, Object... parameters) {
        super(message, cause);
        this.parameters = parameters;
    }

    /**
     * Proporciona la instància de {@link I18NTranslator2} que s'emprarà per
     * traduir els missatges.
     * @return instància per traduir els missatges.
     */
    protected abstract I18NTranslator2 getTranslator();
