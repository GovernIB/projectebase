...
@WebService(targetNamespace = "http://impl.v1.ws.projectebase.caib.es/", name = "HelloWorldWithSecurityWs")
@SOAPBinding(style = SOAPBinding.Style.RPC)
public interface HelloWorldWithSecurityWs {

    @WebResult(name = "return", targetNamespace = "http://impl.v1.ws.projectebase.caib.es/", partName = "return")
    @WebMethod
