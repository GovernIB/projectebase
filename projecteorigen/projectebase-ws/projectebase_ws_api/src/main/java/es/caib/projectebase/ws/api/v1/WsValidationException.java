...
@WebFault(name = "WsValidationErrors", targetNamespace = "http://impl.v1.ws.projectebase.caib.es/")
public class WsValidationException extends Exception {
    public static final long serialVersionUID = 20140704084846L;

    private es.caib.projectebase.ws.api.v1.WsValidationErrors wsValidationErrors;
    ...
    public WsValidationException(String message, es.caib.projectebase.ws.api.v1.WsValidationErrors wsValidationErrors) {
        super(message);
        this.wsValidationErrors = wsValidationErrors;
    }

    public WsValidationException(String message, es.caib.projectebase.ws.api.v1.WsValidationErrors wsValidationErrors, Throwable cause) {
        super(message, cause);
        this.wsValidationErrors = wsValidationErrors;
    }

    public es.caib.projectebase.ws.api.v1.WsValidationErrors getFaultInfo() {
