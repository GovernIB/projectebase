...
create index PBS_UNITAT_CODIDIR3_UK_I on PBS_UNITATORGANICA (CODIDIR3);
 ...
 -- INICI GRANTS
    grant select on PBS_PROCEDIMENT_SEQ start with 1 increment by  1 to www_projectebase;
    grant select on PBS_UNITATORGANICA_SEQ start with 1 increment by  1 to www_projectebase;
    grant select,insert,delete,update on PBS_PROCEDIMENT to www_projectebase;
    grant select,insert,delete,update on PBS_UNITATORGANICA to www_projectebase;
 -- FINAL GRANTS
