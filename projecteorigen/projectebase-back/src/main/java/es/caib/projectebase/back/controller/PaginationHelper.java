...
public abstract class PaginationHelper<E extends Serializable> {
    ...
    /**
     * Actualitza el model de dades. Les implementacions han de cridar {@link #setCount(int)} amb el
     * nombre tota de registres, i {@link #setModel(List)} amb els registres corresponents a la pàgina
     * actual (el primer serà {@link #getPageFirstItem()} i n'hi haurà com a màxim {@link #getPageSize()}.
     */
