...
Per provar el plugin:
    ...
    3. Executar l'script "distribucio_create_schema.sql" dins la mateixa base de dades de projectebase.
    ...
    4. Desplegar l'aplicació dins l'EAR
        ...
        Si s'ha generat amb el mòdul projectebase-api-interna, dins aquest s'inclou un Domini DISTRIBUCIO
        que retorna les unitats adminsitratives actives creades.

        Per provar el domini dins DISTRIBUCIO cal emprar la URL:

            http://localhost:8080/projectebaseapi/interna/services/distribucio/dominis/unitats
