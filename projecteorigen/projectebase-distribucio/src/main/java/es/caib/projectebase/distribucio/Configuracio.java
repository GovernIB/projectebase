...
public class Configuracio {
    ...
    private static final String ENDPOINT_PROPERTY = "es.caib.projectebase.distribucio.endpoint";
    private static final String USERNAME_PROPERTY = "es.caib.projectebase.distribucio.username";
    private static final String PASSWORD_PROPERTY = "es.caib.projectebase.distribucio.password";
