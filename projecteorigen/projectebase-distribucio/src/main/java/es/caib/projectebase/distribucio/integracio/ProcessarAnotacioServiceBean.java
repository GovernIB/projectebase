...
import es.caib.projectebase.distribucio.converter.AnotacioInboxConverter;
import es.caib.projectebase.distribucio.persistence.AnotacioInbox;
import es.caib.projectebase.distribucio.repository.AnotacioInboxRepository;
import es.caib.projectebase.distribucio.repository.CannotLockException;
...
public class ProcessarAnotacioServiceBean implements ProcessarAnotacioService {
    ...
    @Inject
    @ConfigProperty(name = "es.caib.projectebase.distribucio.organs")
    private List<String> organs;

    @Inject
    @ConfigProperty(name = "es.caib.projectebase.distribucio.serieDocumental")
    private String serieDocumental;

    @Inject
    @ConfigProperty(name = "es.caib.projectebase.distribucio.prefixExpedient")
