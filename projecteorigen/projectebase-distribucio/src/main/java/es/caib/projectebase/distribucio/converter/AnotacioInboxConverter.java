package es.caib.projectebase.distribucio.converter;
...
public interface AnotacioInboxConverter {
    ...
    AnotacioInbox toAnotacioInbox(
            es.caib.projectebase.distribucio.backoffice.api.AnotacioRegistreId anotacionsRegistreId);

    List<AnotacioInbox> toAnotacioInbox(
            List<es.caib.projectebase.distribucio.backoffice.api.AnotacioRegistreId> anotacionsRegistre);
}
