 ...
 * 
 */
public class ProjecteBaseArchetypeMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof ProjecteBaseArchetypeMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof ProjecteBaseArchetypeMaxUploadSizeExceededException) {
          msgCode = ((ProjecteBaseArchetypeMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
