...
set MAVEN_OPTS="-Dfile.encoding=UTF-8" && mvn org.apache.maven.plugins:maven-archetype-plugin:3.2.0:generate -B -DarchetypeGroupId=es.caib.projectebase ^
  -DarchetypeArtifactId=projectebase-archetype -DarchetypeVersion=1.0.14 -Dpackage=es.caib.projectebase ^
  ...
  -DperfilDistribucio=true -DperfilPinbal=true -DperfilBatSh=true -DperfilWS=true -DperfilApiInterna=true ^
