...
set MAVEN_OPTS="-Dfile.encoding=UTF-8" && mvn org.apache.maven.plugins:maven-archetype-plugin:3.2.0:generate -B -DarchetypeGroupId=es.caib.projectebase ^
  -DarchetypeArtifactId=projectebase-archetype -DarchetypeVersion=1.0.8 -Dpackage=es.caib.projectebase ^
  ...
  -DperfilSistra2=true -DperfilBatSh=true -DperfilWS=true -DperfilApiInterna=true -DperfilApiExterna=true